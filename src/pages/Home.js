    ...
    <div className="w-full h-full flex lg:items-end py-5 lg:mt-auto">
      <div className="lg:w-9/12 w-11/12 mx-auto">
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-7 items-end md:mt-12 mt-5">
          <motion.div initial={{ y: 200 }} animate={{ y: 0 }} transition={{ duration: 1 }} className="flex-1">
            <img src={Building} alt="skyline" className="w-full overflow-hidden rounded" />
          </motion.div>
          <div className="flex-1">
            <div className="lg:w-8/12">
              {/* Animation for paragraph */}
              <motion.p initial={{ x: 200 }} animate={{ x: 0 }} transition={{ duration: 1 }}>
                {t("home.para")}
              </motion.p>
              {/* rating */}
              <motion.div initial={{ y: 200 }} animate={{ y: 0 }} transition={{ duration: 1 }}>
                ...
                <div className="mt-2 flex gap-3">
                  ...
                  <Button title={t("home.button.real-estate")} icon={faArrowUp} />
                </div>
              </motion.div>
            </div>
          </div>
